...
//}
//
// static void CellToVertexVarcharFunction(DataChunk &args, ExpressionState
// &state,
//                                        Vector &result) {
//  auto &inputs = args.data[0];
//  auto &inputs2 = args.data[1];
...
//}
//
// static void VertexToLatVarcharFunction(DataChunk &args, ExpressionState
// &state,
//                                       Vector &result) {
//  auto &inputs = args.data[0];
...
//}
//
// static void VertexToLngVarcharFunction(DataChunk &args, ExpressionState
// &state,
//                                       Vector &result) {
//  auto &inputs = args.data[0];
//  UnaryExecutor::ExecuteWithNulls<string_t, double>(
