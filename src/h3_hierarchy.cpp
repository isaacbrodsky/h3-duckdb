...
//  BinaryExecutor::ExecuteWithNulls<T, int, T>(
//      inputs, inputs2, result, args.size(),
//      [&](T input, int res, ValidityMask &mask, idx_t idx) {
//        H3Index parent;
...
//}
//
// static void CellToParentVarcharFunction(DataChunk &args, ExpressionState
// &state,
//                                        Vector &result) {
//  auto &inputs = args.data[0];
//  auto &inputs2 = args.data[1];
...
//
// template <typename T>
// static void CellToChildrenSizeFunction(DataChunk &args, ExpressionState
// &state,
//                                       Vector &result) {
//  auto &inputs = args.data[0];
//  auto &inputs2 = args.data[1];
...
//
// template <typename T>
// static void CellToCenterChildFunction(DataChunk &args, ExpressionState
// &state,
//                                      Vector &result) {
//  auto &inputs = args.data[0];
//  auto &inputs2 = args.data[1];
...
//  auto &inputs = args.data[0];
//  auto &inputs2 = args.data[1];
//  BinaryExecutor::ExecuteWithNulls<T, int, int64_t>(
//      inputs, inputs2, result, args.size(),
//      [&](T input, int res, ValidityMask &mask, idx_t idx) {
//        int64_t child;
...
//  auto &inputs2 = args.data[1];
//  auto &inputs3 = args.data[2];
//  TernaryExecutor::ExecuteWithNulls<int64_t, T, int, T>(
//      inputs, inputs2, inputs3, result, args.size(),
//      [&](int64_t pos, T input, int res, ValidityMask &mask, idx_t idx) {
//        H3Index child;
...
//}
//
// static void CompactCellsVarcharFunction(DataChunk &args, ExpressionState
// &state,
//                                        Vector &result) {
//  D_ASSERT(args.ColumnCount() == 1);
//  auto count = args.size();
...
//  LogicalType::INTEGER},
//                                   LogicalType::UBIGINT,
//                                   CellToParentFunction<uint64_t>));
//  funcs.AddFunction(ScalarFunction({LogicalType::BIGINT,
//  LogicalType::INTEGER},
//                                   LogicalType::BIGINT,
//                                   CellToParentFunction<int64_t>));
...
//  LogicalType::INTEGER},
//                                   LogicalType::UBIGINT,
//                                   CellToCenterChildFunction<uint64_t>));
//  funcs.AddFunction(ScalarFunction({LogicalType::BIGINT,
//  LogicalType::INTEGER},
//                                   LogicalType::BIGINT,
//                                   CellToCenterChildFunction<int64_t>));
//  return CreateScalarFunctionInfo(funcs);
//}
//
...
//  LogicalType::INTEGER},
//                                   LogicalType::BIGINT,
//                                   CellToChildPosFunction<uint64_t>));
//  funcs.AddFunction(ScalarFunction({LogicalType::BIGINT,
//  LogicalType::INTEGER},
//                                   LogicalType::BIGINT,
//                                   CellToChildPosFunction<int64_t>));
//  return CreateScalarFunctionInfo(funcs);
//}
//
...
//      LogicalType::UBIGINT, ChildPosToCellFunction<uint64_t>));
//  funcs.AddFunction(ScalarFunction(
//      {LogicalType::BIGINT, LogicalType::BIGINT, LogicalType::INTEGER},
//      LogicalType::BIGINT, ChildPosToCellFunction<int64_t>));
//  return CreateScalarFunctionInfo(funcs);
//}
//
