...
//// (string)
//
// static void GetHexagonAreaAvgFunction(DataChunk &args, ExpressionState
// &state,
//                                      Vector &result) {
...
//}
//
// static void EdgeLengthVarcharFunction(DataChunk &args, ExpressionState
// &state,
//                                      Vector &result) {
//  auto &inputs = args.data[0];
//  auto &inputs2 = args.data[1];
...
//}
//
// static void GetRes0CellsVarcharFunction(DataChunk &args, ExpressionState
// &state,
//                                        Vector &result) {
//  auto result_data = FlatVector::GetData<list_entry_t>(result);
//
...
//}
//
// static void GetPentagonsVarcharFunction(DataChunk &args, ExpressionState
// &state,
//                                        Vector &result) {
//  auto result_data = FlatVector::GetData<list_entry_t>(result);
//
...
//}
//
// static void GreatCircleDistanceFunction(DataChunk &args, ExpressionState
// &state,
//                                        Vector &result) {
