...
// namespace duckdb {
//
// static void DirectedEdgeToCellsFunction(DataChunk &args, ExpressionState
// &state,
//                                        Vector &result) {
...
//
// template <typename T>
// static void CellsToDirectedEdgeFunction(DataChunk &args, ExpressionState
// &state,
//                                        Vector &result) {
//  auto &inputs = args.data[0];
...
//
// template <typename T>
// static void ReverseDirectedEdgeFunction(DataChunk &args, ExpressionState
// &state,
//                                        Vector &result) {
//  auto &inputs = args.data[0];
//  UnaryExecutor::ExecuteWithNulls<T, T>(
...
//
// template <typename T>
// static void IsValidDirectedEdgeFunction(DataChunk &args, ExpressionState
// &state,
//                                        Vector &result) {
//  auto &inputs = args.data[0];
